...
datapath = 'C:/Users/cfo/Documents/Data_Analysis/STL_Acquisition/STL_Data/2023-06-19 #SG19 ref(1) W UHV RT/STL_35'
...
plt.imshow(E0, cmap=cmap1, aspect=1, extent=[image_size[1], 0, image_size[0], 0], interpolation='none')
...
plt.imshow(np.log10(A0), cmap=cmap1, aspect=1, extent=[image_size[1], 0, image_size[0], 0], interpolation='none')
clb = plt.colorbar(pad = 0.2)
