...
if Ech_log:
    ...
    plt.imshow(I, cmap=cmap1, extent=[image_size[1], 0, image_size[0], 0], interpolation='none')
    clb = plt.colorbar(pad=0.2)
    clb.set_label('Integrated intensity (arb. units)', labelpad=20, y=0.5, rotation=270, fontsize=16)
