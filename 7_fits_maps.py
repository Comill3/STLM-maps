...
if Log:
    ...
    clb.set_label(
        "log10(A1) (arb. units)", labelpad=20, y=0.5, rotation=270, fontsize=16
    )
...
clb = plt.colorbar(pad=0.2)
clb.set_label(r"$2.355 * \sigma$1 (eV)", labelpad=20, y=0.5, rotation=270, fontsize=16)
clb.ax.tick_params(labelsize=14)
...
ax3.set_ylabel(r"Histogram 2.355 * $\sigma$1", fontsize=16)
ax3.set_xlabel(r"$2.355 * \sigma$1 (eV)", fontsize=16)
