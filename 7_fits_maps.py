...
plt.imshow(E1, cmap=cmap1, aspect=1, extent=[image_size[1], 0, image_size[0], 0], interpolation='none', vmax=2.31)
...
ax1 = fig.add_subplot(spec[0])
plt.imshow(B1, cmap=cmap1, aspect=1, extent=[image_size[1], 0, image_size[0], 0], interpolation='none')
clb = plt.colorbar(pad = 0.2)
clb.set_label('B1 (arb. units)', labelpad=20, y=0.5, rotation=270, fontsize=16)
clb.ax.tick_params(labelsize=14)
ax1.set_ylabel('Position (nm)', rotation=270, fontsize=12)
ax1.set_xlabel('Position (nm)', fontsize=12)
ax1.tick_params(axis='x', labelsize=10)
...
ax1 = fig.add_subplot(spec[0])
plt.imshow(np.abs(Ratio), cmap=cmap1, aspect=1, extent=[image_size[1], 0, image_size[0], 0], interpolation='none', vmax=0.4)
clb = plt.colorbar(pad = 0.2)
